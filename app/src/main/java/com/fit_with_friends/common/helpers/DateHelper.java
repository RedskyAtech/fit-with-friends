...
public class DateHelper implements JsonSerializer<Date>, JsonDeserializer<Date> {
    ...
    public static Date getDayNext(int days) {
        Calendar calendar = Calendar.getInstance();
        calendar.add(Calendar.DATE, days);
        return calendar.getTime();
    ...
    public static Date getDayNext(int days, Date date) {
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(date);
        calendar.add(Calendar.DATE, days);
        return calendar.getTime();
    ...
    public static String localToUtcTimestampConverter(String time) throws ParseException {
        ...
        SimpleDateFormat converted = new SimpleDateFormat("mm-dd-yyyy hh:mm", Locale.ENGLISH);
...
//            return diff / HOUR_MILLIS + " hours ago";
    ...
    public static String getAgoTime(String sDate) {
        ...
        _notificationDate = DateHelper.parse(sDate, StringifyAs.Utc);
        _todayDate = DateHelper.parse(DateHelper.stringify(_todayDate, StringifyAs.Utc), StringifyAs.Utc);
    ...
    public static String getMonth(Date date) {
        DateFormat simpleMonthFormat = new SimpleDateFormat("MMMM", Locale.ENGLISH);
        Calendar cl = Calendar.getInstance();
        cl.setTime(date);
        return simpleMonthFormat.format(cl.getTime());
    }
    ...
    public static String getAge(Date dateOfBirth) {
        String year = DateHelper.stringify(dateOfBirth, "yyyy");
        int yrs = Integer.valueOf(year);

        Calendar today = Calendar.getInstance();

        int age = today.get(Calendar.YEAR) - yrs;
    ...
    public static String getAge(String dateOfBirth) {
        ...
        try {
            ...
            String year = DateHelper.stringify(date, "yyyy");

            int yrs = Integer.valueOf(year);

            Calendar today = Calendar.getInstance();

            age = today.get(Calendar.YEAR) - yrs;
        } catch (ParseException e) {
            e.printStackTrace();
        }
