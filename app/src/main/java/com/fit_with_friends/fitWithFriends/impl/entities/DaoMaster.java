...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        ...
        MotivationDao.createTable(db, ifNotExists);
        ConnectionDao.createTable(db, ifNotExists);
        WeightLogDao.createTable(db, ifNotExists);
    }
    ...
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        ...
        MotivationDao.dropTable(db, ifExists);
        ConnectionDao.dropTable(db, ifExists);
        WeightLogDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(MotivationDao.class);
        registerDaoClass(ConnectionDao.class);
        registerDaoClass(WeightLogDao.class);
    }
