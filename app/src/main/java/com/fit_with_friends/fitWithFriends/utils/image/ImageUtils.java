...
import com.fit_with_friends.fitWithFriends.views.maskedimageview.MaskedImageView;
...
public class ImageUtils {
    ...
    public static String saveUriToFile(Uri uri) throws Exception {
        ...
        String fileName = System.currentTimeMillis() + CAMERA_FILE_EXT;
    ...
    private static Drawable getRoundIconDrawable(Bitmap avatarBitmap, int size) {
        ...
        int color = App.getInstance().getResources().getColor(R.color.grayed_color);
    ...
    public static void showActivityImages(String picUrl, MaskedImageView activityImage) {
        String extension = picUrl.substring(picUrl.lastIndexOf(".") + 1);
        switch (extension) {
            /*case "pdf":
                activityImage.setImageResource(R.mipmap.pdf);
                break;
            case "docx":
                activityImage.setImageResource(R.mipmap.doc);
                break;
            case "txt":
                activityImage.setImageResource(R.mipmap.text);
                break;
            case "zip":
                activityImage.setImageResource(R.mipmap.zip);
                break;
            case "ppt":
                activityImage.setImageResource(R.mipmap.ppt);
                break;
            case "pptx":
                activityImage.setImageResource(R.mipmap.ppt);
                break;
            case "rtf":
                activityImage.setImageResource(R.mipmap.rtf);
                break;
            case "html":
                activityImage.setImageResource(R.mipmap.html);
                break;*/
            default:
                displayImageByUrl(picUrl, activityImage);
                break;
        }
    }

    private static void displayImageByUrl(String publicUrl, MaskedImageView imageView) {
        ImageLoader.getInstance().displayImage(publicUrl, imageView,
                ImageLoaderUtils.UIL_USER_AVATAR_DISPLAY_OPTIONS_BLUR);
    }
}