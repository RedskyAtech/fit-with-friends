...
public class ImageLoaderUtils {
    ...
    public static final DisplayImageOptions UIL_USER_AVATAR_DISPLAY_OPTIONS = new DisplayImageOptions.Builder()
            .showImageOnLoading(R.mipmap.harry).showImageForEmptyUri(R.mipmap.harry)
            .showImageOnFail(R.mipmap.harry).cacheOnDisc(true).cacheInMemory(true).build();

    public static final DisplayImageOptions UIL_USER_AVATAR_DISPLAY= new DisplayImageOptions.Builder()
            .showImageOnLoading(R.mipmap.harry).showImageForEmptyUri(R.mipmap.harry)
            .showImageOnFail(R.mipmap.harry).cacheOnDisc(true).cacheInMemory(true).build();

    public static final DisplayImageOptions UIL_USER_AVATAR_DISPLAY_OPTIONS_FACULTY = new DisplayImageOptions.Builder()
            .showImageOnLoading(R.mipmap.harry).showImageForEmptyUri(R.mipmap.harry)
            .showImageOnFail(R.mipmap.harry).cacheOnDisc(true).cacheInMemory(true).build();

    public static final DisplayImageOptions UIL_USER_AVATAR_DISPLAY_OPTIONS_BLUR = new DisplayImageOptions.Builder()
            .showImageOnLoading(R.mipmap.harry).showImageForEmptyUri(R.mipmap.harry)
            .showImageOnFail(R.mipmap.harry).cacheOnDisc(true).cacheInMemory(true).build();

    public static final DisplayImageOptions UIL_GROUP_AVATAR_DISPLAY_OPTIONS = new DisplayImageOptions.Builder()
            .showImageOnLoading(R.mipmap.harry).showImageForEmptyUri(
                    R.mipmap.harry).showImageOnFail(R.mipmap.harry).cacheOnDisc(
      ...
      @Override
        ...
        private void addVideoIcon(Bitmap source) {
            ...
            Bitmap icon = BitmapFactory
                    .decodeResource(context.get().getResources(), R.mipmap.harry);
