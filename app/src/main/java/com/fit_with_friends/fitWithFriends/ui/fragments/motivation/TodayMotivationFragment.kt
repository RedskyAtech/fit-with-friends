...
import kotlinx.android.synthetic.main.fragment_today_motivation.*
...
class TodayMotivationFragment : BaseV4Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_today_motivation, container, false)
    }
    ...
    private fun getTodayMotivation() {
        startAnim()
            ...
            object : AsyncResult<MotivationModel> {
                override fun success(motivationModel: MotivationModel) {
                    ...
                    activity!!.runOnUiThread {
                        stopAnim()
                        if (swipeRefresh_today_motivation != null) {
                            swipeRefresh_today_motivation.isRefreshing = false
                        }
                        if (motivationModel.today_motivation != null) {
                            if (motivationModel.today_motivation.size != 0) {
                                if (recyclerView_today_motivation != null) {
                                    recyclerView_today_motivation.visibility = View.VISIBLE
                                }
                                if (textView_today_motivation != null) {
                                    textView_today_motivation.visibility = View.GONE
                                }
                                motivationModelList.clear()
                                motivationModelList.addAll(motivationModel.today_motivation)
                                motivationTypeAdapter.notifyDataSetChanged()
                            } else {
                                if (recyclerView_today_motivation != null) {
                                    recyclerView_today_motivation.visibility = View.GONE
                                }
                                if (textView_today_motivation != null) {
                                    textView_today_motivation.visibility = View.VISIBLE
                                }
                            }
                        }
                    }
    ...
    private fun listeners() {
        swipeRefresh_today_motivation.setOnRefreshListener {
            swipeRefresh_today_motivation.setColorSchemeResources(
    ...
    private fun setAdapter() {
        ...
        recyclerView_today_motivation.layoutManager = LinearLayoutManager(activity)
        recyclerView_today_motivation.adapter = motivationTypeAdapter
    }
    ...
    private fun startAnim() {
        if (avi_loader_today_motivation != null) {
            avi_loader_today_motivation.smoothToShow()
        }
    }

    internal fun stopAnim() {
        if (avi_loader_today_motivation != null) {
            avi_loader_today_motivation.smoothToHide()
        }
    }
}
